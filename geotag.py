...
if __name__ == "__main__":
    ...
    print( GT.query("Rome"))
    # print GT.query("Dallas")
    # print GT.query("Brooklyn")
    # print GT.query("Bronx")
    # print GT.query("Las Vegas")
    # print GT.query("Kathmandu")
    # print GT.query("New Delhi")
    # print GT.query("Mumbai")
    # print GT.query("Mecca")